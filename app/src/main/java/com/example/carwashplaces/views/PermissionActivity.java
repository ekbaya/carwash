...
public class PermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(PermissionActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) ==
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse response) {
                                if (response.isPermanentlyDenied()) {
                                    ...
                                    builder.setTitle("Permission Denied")
                                            .setMessage("Permission to accesses device location is permanently denied. You need to go to settings to allow the permission.")
